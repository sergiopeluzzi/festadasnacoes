                            ...
                            @foreach($nacoes as $nacao)
                                <tr>
                                    ...
                                    <td class="text-center no-padding">
                                        ...
                                        <a class="btn btn-sm bg-gray" href="{{ URL::to('admin/nacoes/' . $nacao->id) }}"><i class="glyphicon glyphicon-user"></i></a>
                                        <!-- edit this nerd (uses the edit method found at GET /nerds/{id}/edit -->
                                        <a class="btn btn-sm bg-gray" href="{{ URL::to('admin/nacoes/' . $nacao->id . '/edit') }}"><i class="glyphicon glyphicon-edit"></i></a>
                                        <a>
